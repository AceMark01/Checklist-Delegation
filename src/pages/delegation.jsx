      ...
      {showHistory && selectedHistoryItems.size > 0 && (
        ...
        >
          {isSubmittingHistory ? (
            ...
            `DONE (${selectedHistoryItems.size})`
          )}
        </button>
      )}
...
<div className="overflow-x-auto lg:overflow-visible">
        ...
        {filteredHistoryData.length > 0 ? (
          ...
          <tr>
            <td colSpan={userRole === "admin" ? 10 : 9} className="px-6 py-4 text-center text-gray-500">
              {searchTerm || startDate || endDate ? "No historical records matching your filters" : "No completed records found"}
            </td>
          </tr>
        )}
      </tbody>
        ...
        return (
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              ...
              <div className="space-y-2">
                <span className="text-xs text-gray-500 font-medium">Next Target</span>
            ...
            <div className="bg-purple-50 p-4 rounded-lg mb-6">
              <span className="text-xs font-medium text-purple-800 block mb-2">Remarks</span>
  ...
  {filteredAccountData.length > 0 ? (
    filteredAccountData.map((account) => {
      ...
      return (
        ...
        >
          ...
          <p><strong>Task ID:</strong> {account.col1 || "—"}</p>
          <p><strong>Department:</strong> {account.col2 || "—"}</p>
          <p><strong>Given By:</strong> {account.col3 || "—"}</p>
          <p><strong>Name:</strong> {account.col4 || "—"}</p>
          <p><strong>Description:</strong> {account.col5 || "—"}</p>

          <p><strong>Start Date:</strong> {formatDateForDisplay(account.col6)}</p>
          <p><strong>Planned Date:</strong> {formatDateForDisplay(account.col10)}</p>
          ...
          {/* Next Target Date */}
          <div className="mt-2">
            <label className="text-sm font-semibold">Next Target Date:</label>
            <input
              type="date"
              disabled={
                !isSelected ||
    ...
    <p className="text-center text-gray-500">
      {searchTerm ? "No tasks matching search" : "No pending tasks found"}
    </p>
  )}
</div>

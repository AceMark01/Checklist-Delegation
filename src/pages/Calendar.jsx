          ...
          <div className="sticky top-0 bg-white border-b-2 border-gray-200 p-4 sm:p-6">
            ...
            <div className="flex flex-wrap gap-2 mb-3">
              <button
                ...
                className={`px-3 sm:px-4 py-1.5 rounded-lg font-medium transition-all text-xs sm:text-sm ${sheetFilter === "all"
              ...
              <button
                ...
                className={`px-3 sm:px-4 py-1.5 rounded-lg font-medium transition-all text-xs sm:text-sm ${sheetFilter === "delegation"
              ...
              <button
                ...
                className={`px-3 sm:px-4 py-1.5 rounded-lg font-medium transition-all text-xs sm:text-sm ${sheetFilter === "checklist"

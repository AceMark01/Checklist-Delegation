      ...
      <div className="space-y-6">
        <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
          <h1 className="text-2xl font-bold tracking-tight text-purple-700">
            {showHistory ? t('nav.history') : t('nav.adminData')}
          </h1>
            ...
            {showHistory && selectedHistoryItems.length > 0 && (
              <div className="fixed top-40 right-10 z-50">
                ...
                >
                  {markingAsDone
                    ? t('common.submitting')
                    : t('delegation.markAsDone') + ` (${selectedHistoryItems.length})`
                  }
                </button>
              </div>
            )}
                          ...
                          {account.image ? (
                            ...
                            <label className={`flex items-center cursor-pointer ${account['col10']?.toUpperCase() === "YES" ? "text-red-600 font-medium" : "text-purple-600"} hover:text-purple-800`}>
                              ...
                              <span className="text-xs">
                                {account['col10']?.toUpperCase() === "YES" ? t('delegation.requiredUpload') : t('delegation.uploadImage')}

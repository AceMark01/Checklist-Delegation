...
function PurchaseDataPage() {
  ...
  const fetchSheetData = async () => {
    try {
      ...
      const response = await fetch(`https://docs.google.com/spreadsheets/d/1OML53kwf2UBXyp6beojKt1Nhn-bUS8iu8I4-AUz9ngE/gviz/tq?tqx=out:json&sheet=${CONFIG.SHEET_NAME}`);
      ...
      <div className="space-y-6">
        <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
          <h1 className="text-2xl font-bold tracking-tight text-purple-700">
            {showHistory ? t('nav.history') + " " + t('nav.purchase') : t('nav.purchase')}
          </h1>

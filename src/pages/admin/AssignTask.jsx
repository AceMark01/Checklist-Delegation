...
export default function AssignTask() {
  ...
  const frequencies = [
    { value: "one-time", label: t('assignTask.oneTime') },
    { value: "daily", label: t('assignTask.daily') },
    { value: "weekly", label: t('assignTask.weekly') },
    { value: "fortnightly", label: t('assignTask.fortnightly') },
    { value: "monthly", label: t('assignTask.monthly') },
    { value: "quarterly", label: t('assignTask.quarterly') },
    { value: "half-yearly", label: t('assignTask.halfYearly') },
    { value: "yearly", label: t('assignTask.yearly') },
    { value: "end-of-1st-week", label: t('assignTask.endOf1stWeek') },
    { value: "end-of-2nd-week", label: t('assignTask.endOf2ndWeek') },
    { value: "end-of-3rd-week", label: t('assignTask.endOf3rdWeek') },
    { value: "end-of-4th-week", label: t('assignTask.endOf4thWeek') },
    { value: "end-of-last-week", label: t('assignTask.endOfLastWeek') },
  ];
  ...
  const getFormattedDate = (date) => {
    if (!date) return t('assignTask.selectDate');
    ...
    if (formData.frequency === "one-time") {
      ...
      while (currentIndex < futureDates.length) {
        ...
        switch (formData.frequency) {
          ...
          case "half-yearly": {
            // Find a working day approximately 6 months later
            const [taskDay7, taskMonth7, taskYear7] = taskDateStr.split('/').map(Number);
            const currentDate7 = new Date(taskYear7, taskMonth7 - 1, taskDay7);
            const targetDate7 = addMonths(currentDate7, 6);
            const targetDateStr7 = formatDateToDDMMYYYY(targetDate7);

            const nextIndex7 = findClosestWorkingDayIndex(futureDates, targetDateStr7);
            currentIndex = nextIndex7 > currentIndex ? nextIndex7 : futureDates.length;
            break;
          }
          case "monthly": {
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="space-y-2">
                ...
                >
                  <option value="">{t('assignTask.selectDepartment')}</option>
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full rounded-md border border-purple-200 px-3 py-2 text-sm focus:border-purple-500 focus:outline-none focus:ring-1 focus:ring-purple-500"
                >
                  <option value="">{t('assignTask.selectGivenBy')}</option>
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full rounded-md border border-purple-200 px-3 py-2 text-sm focus:border-purple-500 focus:outline-none focus:ring-1 focus:ring-purple-500"
                >
                  <option value="">{t('assignTask.selectDoer')}</option>
              ...
              <div className="space-y-4 pt-2 border-t border-purple-100">
                <h3 className="text-lg font-medium text-purple-700 pt-2">
                  {t('assignTask.additionalOptions')}
                </h3>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-purple-600">
                      {t('assignTask.remindersSubtitle')}
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-purple-600">
                      {t('assignTask.attachmentSubtitle')}
                    </p>
                  </div>
                  <div className="flex items-center space-x-2">
                    ...
                    <div className="border border-purple-200 rounded-md">
                      ...
                      >
                        <span className="font-medium">
                          {generatedTasks.length} {t('dashboard.totalTasks')}
                          {formData.frequency === "one-time"
                            ? ` (${t('assignTask.oneTime')})`
                            : ` (${t('nav.checklist')})`
                          }
                        </span>
                        <svg
                            ...
                            {generatedTasks.slice(0, 20).map((task, index) => (
                              ...
                              >
                                ...
                                <div className="text-xs text-purple-600">
                                  {t('table.date')}: {formatDateForDisplay(task.dueDate)} | {t('assignTask.department')}: {task.department}
                                </div>
